# Домашнее задание к занятию "`Git`" - `Трубицын Михаил`
...
[Ссылка на граф коммитов репозитория git-8_01. Задание 3](https://github.com/mishatru/git-8_01/network)


### Задание 4

[Ссылка на граф коммитов задания 4](https://github.com/mishatru/git-8_01/network)
